...
这个月花了很多时间折腾笔记软件。多年前开始折腾笔记软件的时候，我的初衷是提高效率。但我后来意识到笔记软件对于效率的影响其实非常有限，所以这件事情对于我逐渐变成了一个消遣和爱好。
...
目前是 Notion 和 roam 搭配使用，Notion 用来管理日常任务，以及写一些固定类型的长笔记，roam 主要用于各种片段的收集、加工和组装，实践类似于 slip-box notes 和 [Evergreen notes ](https://notes.andymatuschak.org/z4SDCZQeRo4xFEQ8H4qrSqd68ucpgE6LU155C) 的笔记方法。
